...
export function TripOnboarding({ onLoad, onBlank, onPaste }: { onLoad: () => void; onBlank: () => void; onPaste: () => void }) {
  ...
  return <div className="space-y-5">
    ...
    <div className="rounded-2xl border p-6">
      ...
      <div className="mt-5 flex flex-wrap gap-5 text-sm underline underline-offset-4"><a href="/trips/minimal-trip.yaml" download>Example trip</a><a href="/format.md" target="_blank" rel="noreferrer">Format guide</a><a href="/trip.schema.json" target="_blank" rel="noreferrer">JSON Schema</a></div>
    </div>
