...
function LocalPreview() {
  ...
  return session ? <AgentPreview key={session} session={session} /> : <main className="mx-auto max-w-xl p-10"><h1 className="text-2xl font-semibold">Roamwise</h1><p className="mt-4">Open a trip from your agent or terminal:</p><pre className="mt-4 rounded-xl bg-neutral-100 p-4">roamwise open edinburgh-trip.yaml</pre></main>;
}
